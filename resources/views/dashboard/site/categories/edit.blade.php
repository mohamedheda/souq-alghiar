                    ...
                    <div class="card">
                        <form action="{{ route('categories.update',$category->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.category')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_ar" type="text" class="form-control"
                                                   ...
                                                   value="{{ $category->name_ar }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('name_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $category->name_en }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('name_en')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <img src="{{asset($category->image)}}" width="auto" height="100px">
                                        </div>
                                    </div>
                                    @error('logo')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <label>
                                            <input type="checkbox" name="show_home" value="{{$category->show_home}}" {{ $category->show_home ? 'checked' : '' }}>
