...
@endphp
@section('title', __('dashboard.marks'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.marks')</h3>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                            <div class="operations-btns" style="">
                                                ...
                                                <a href="{{ route('marks.models', $mark->id) }}"
                                                   class="btn  btn-dark">@lang('dashboard.models')</a>
