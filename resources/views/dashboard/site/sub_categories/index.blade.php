...
@endphp
@section('title', __('dashboard.sub_categories'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.sub_categories')</h3>
                            <div class="card-tools">
                                <a href="{{ route('categories.sub_categories.create',$category_id) }}"
